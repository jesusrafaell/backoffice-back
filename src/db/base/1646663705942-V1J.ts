...
export class V1J1646663705942 implements MigrationInterface {
	name = 'V1J1646663705942';
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`CREATE TABLE "fm_ciudad" ("id" int NOT NULL IDENTITY(1,1), "ciudad" nvarchar(255), "area_code" nvarchar(255), "postal_code" nvarchar(255), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_da62da8d36d6f19e911ebaf9c3a" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_f6627f121e3b26ad9671af9098e" DEFAULT getdate(), "id_estado" int, CONSTRAINT "PK_663e8a8ca7f60889e6920d5c716" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "fm_municipio" ("id" int NOT NULL IDENTITY(1,1), "municipio" nvarchar(255), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_b09796cab2d0f8e081b3871314c" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_32a2657a133fe7596a6ba843dee" DEFAULT getdate(), "id_estado" int, CONSTRAINT "PK_87e63f0fe36429d5c71d71dd593" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
			`CREATE TABLE "fm_estado" ("id" int NOT NULL IDENTITY(1,1), "estado" nvarchar(255), "iso_3166" nvarchar(255), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_aa3194b27d8573a8595f114b27e" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_ab1300b2dd07d94beb72f21d151" DEFAULT getdate(), CONSTRAINT "PK_be76dfa8112c92facba26c76484" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE UNIQUE INDEX "REL_9af2a5b750e303f6a4e5870a44" ON "fm_dir_pos" ("id_request") WHERE "id_request" IS NOT NULL`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "fm_department" ("id" int NOT NULL IDENTITY(1,1), "name" nvarchar(255), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_88e4e6cd33457fb1d2786f6a632" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_889fc26b13d39fe4ea250bbfa4c" DEFAULT getdate(), CONSTRAINT "PK_eadfe195782d7e0aebd062cccb9" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "fm_roles" ("id" int NOT NULL IDENTITY(1,1), "name" nvarchar(255), "createdAt" datetime2 NOT NULL CONSTRAINT "DF_14894554fc7a0216fe7d3bac62c" DEFAULT getdate(), "updatedAt" datetime2 NOT NULL CONSTRAINT "DF_aad4135a4b113abe218828517a0" DEFAULT getdate(), CONSTRAINT "PK_b0f909dbec9a1d1a8a9b8e10ede" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
