...
export class Pos1648650875004 implements MigrationInterface {
    name = 'Pos1648650875004'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "fm_pos_xcommerce" ("id" int NOT NULL IDENTITY(1,1), "aboTerminal" nvarchar(255), "serial" nvarchar(255), "id_cartera" int, "id_cartera_ter" int, "id_location" int, "id_commerce" int, "id_request" int, "id_product" int, CONSTRAINT "UQ_0033d7d0c48233482f86320e33d" UNIQUE ("aboTerminal"), CONSTRAINT "UQ_2e9efe606e3362df4f2438e92b4" UNIQUE ("serial"), CONSTRAINT "PK_9312e1c3e356b5203edd445d376" PRIMARY KEY ("id"))`);
